...
#ifndef RIOENGINE_CLENGINE_CLPHONGCHILD_H_
#define RIOENGINE_CLENGINE_CLPHONGCHILD_H_

#include "cengine/cobject.h"

class CLPhongChild : public CObject {
 public:
...
private:
   void*          m_value;
   PhongChildType m_valueType;
};

#endif  // RIOENGINE_CLENGINE_CLPHONGCHILD_H_
