...
#ifndef RIOENGINE_CLENGINE_CLASSETSREPOSITORY_H_
#define RIOENGINE_CLENGINE_CLASSETSREPOSITORY_H_

#define CLASSETSREPOSITORY CSingleton<CLAssetsRepository>::getSharedInstance()

#include "cengine/csingleton.h"
#include "clengine/clscene.h"

class CLAssetsRepository : public CLScene {
public:
    CLAssetsRepository();
...
#endif  // RIOENGINE_CLENGINE_CLASSETSREPOSITORY_H_
