...
#ifndef RIOENGINE_CLENGINE_CLTRIANGLES_H_
#define RIOENGINE_CLENGINE_CLTRIANGLES_H_
 ...
 */
class CLTriangles : public CObject {
public:
    CLTriangles(void);
...
private:
    virtual void copyValuesFromObject(const CLTriangles& triangles_obj);

    CArray<int>* m_verticesIndices;
    CArray<int>* m_normalsIndices;
    CArray<int>* m_textureCoordIndices;
    std::string  m_materialId;
};

#endif  // RIOENGINE_CLENGINE_CLTRIANGLES_H_
