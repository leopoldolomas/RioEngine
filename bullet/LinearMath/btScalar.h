...
#define BT_DEBUG
        ...
        #if 1
        //#if defined(__MINGW32__) || defined(__CYGWIN__) || (defined (_MSC_VER) && _MSC_VER < 1300) // disabled alignment to avoid several issues, turn alignment on if you want to start a nightmare
