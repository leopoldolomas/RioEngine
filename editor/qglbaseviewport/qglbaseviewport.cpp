...
QGLBaseViewport::QGLBaseViewport(QWidget* parent, QOpenGLWidget*)
...
#define PROGRAM_TEXCOORD_ATTRIBUTE  1
    ...
    QOpenGLShader *solidColor_vshader = new QOpenGLShader(QOpenGLShader::Vertex, this);
    bool result = solidColor_vshader->compileSourceFile(path + "solidcolor.vert");

    QOpenGLShader *solidColor_fshader = new QOpenGLShader(QOpenGLShader::Fragment, this);
    result = solidColor_fshader->compileSourceFile(path + "solidcolor.frag");

    m_solidColorsProgram = new QOpenGLShaderProgram(this);
    ...
    m_texturedProgram = new QOpenGLShaderProgram(this);
...
void QGLBaseViewport::paintGL() {
    ...
    const btVector3 camera_position(0, 0, 0);
